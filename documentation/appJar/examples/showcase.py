...
def toolbar(btn):
    ...
    #elif btn == "MAP":  pass #app.showSubWindow("Maps")
...
with gui("ShowCase") as app:
    ...
    app.addToolbar(["EXIT", "LOGOUT", "FILL", "ACCESS", "PIE-CHART", "CALENDAR", "ADDRESS-BOOK",  "FULL-SCREEN"], toolbar, findIcon=True)
